...
namespace Visitor
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Manager salih = new Manager { Name = "Salih", Salary = 1500 };
           
            Worker derin = new Worker { Name = "Derin", Salary = 1500 };

            Worker ali = new Worker { Name = "Ali", Salary = 1500 };
   ...
   abstract class VisitorBase
    ...
    class PayRiseVisitor : VisitorBase
    {
        public override void Visit(Worker worker)
        {
            Console.WriteLine("{0} salary increased to {1}", worker.Name, worker.Salary*(decimal) 1.05);
        }
